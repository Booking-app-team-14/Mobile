...
// Postavi inicijalni tekst
                                                        editTextReason.setText("Create New Accommodation");
...
//                                                        });
                                                        ...
                                                        buttonLocateOnMap.setOnClickListener(new View.OnClickListener() {
                                                            ...
                                                            public void onClick(View v) {
                                                                ...
                                                                if (address.isEmpty()) {
                                                                    Toast.makeText(CreateAccommodationScreen.this, "Please enter an address.", Toast.LENGTH_SHORT).show();
                                                                } else {
                                                                    locateOnMap(address);
                                                                }
                                                            }
