...
public class GlobalData {
    ...
    private GlobalData() {
        ...
        searchAccommodations.add(new SearchAccommodation(4L, "Downtown Loft", "Modern loft in the heart of the city.", AccommodationType.APARTMENT,new Location(4L,"Serbia","Zlatibor","Katunska 5"), "accommodation_3", 3.3, 4,6, 220.0,new HashSet<>(), true));
        ...
        searchAccommodations.add(new SearchAccommodation(6L, "Seaside Bungalow", "Relaxing bungalow near the beach.", AccommodationType.STUDIO,new Location(6L,"Serbia","Zlatibor","Katunska 7"), "accommodation_4", 4.5, 2,10, 160.0,new HashSet<>(), true));
        ...
        searchAccommodations.add(new SearchAccommodation(8L, "Countryside Cottage", "Charming cottage in a peaceful rural setting.", AccommodationType.ROOM, new Location(8L,"Serbia","Novi Sad","Katunska 6"),"accommodation_7", 3.6, 3,5, 180.0,new HashSet<>(), true));
        searchAccommodations.add(new SearchAccommodation(9L, "Tropical Paradise Villa", "Tropical villa surrounded by lush greenery.", AccommodationType.VILLA,new Location(9l,"Serbia","Zlatibor","Katunska 9"), "accommodation_8", 2.7, 5,7, 300.0,new HashSet<>(), true));
