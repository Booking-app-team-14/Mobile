...
public class OwnersAccommodationDTO {
    ...
    public OwnersAccommodationDTO(Long id, String name, String type, int stars, int maxGuests, String address, double price, String imageType, String mainPictureBytes) {
        this.id = id;
        this.name = name;
        this.type = type;
        this.stars = stars;
