...
public class OwnerReviewAdapter extends RecyclerView.Adapter<OwnerReviewAdapter.ReviewViewHolder> {

    private List<OwnerReview> reviewsList;
    private OwnerReviewsActivity activity;

    private long userId;

    private String userRole;

    public OwnerReviewAdapter(List<OwnerReview> reviewsList) {
...
//    }
    ...
    public OwnerReviewAdapter(List<OwnerReview> reviewsList, OwnerReviewsActivity activity, long userId, String userRole) {
        this.reviewsList = reviewsList;
        this.activity = activity;
        this.userId = userId;
    ...
    @NonNull
    @Override
    public OwnerReviewAdapter.ReviewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_review, parent, false);
        return new OwnerReviewAdapter.ReviewViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OwnerReviewAdapter.ReviewViewHolder holder, int position) {
        OwnerReview review = reviewsList.get(position);
        ...
        holder.reviewDateTime.setText(formatDateTime(review.getTimestamp()));
